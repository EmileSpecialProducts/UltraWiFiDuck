...
const UnicodeToKeyCode_t Keyboard_ES[] =
    {
        ...
        {'o', {HID_KEY_O, 0}},
        {'p', {HID_KEY_P, 0}},
        {0x0060, {HID_KEY_BRACKET_LEFT, 0}}, // dead acute 0x60????
        ...
        {0x005E, {HID_KEY_SHIFT_LEFT, HID_KEY_BRACKET_LEFT, 0}}, // '¨' 0x5e ^ ??
        ...
        {0x00A8, {HID_KEY_SHIFT_LEFT, HID_KEY_APOSTROPHE, 0}},
        ...
        ///////////////////////////////////////////////// ALT GR
        // Top row (numbers)
        {'\\', {HID_KEY_ALT_RIGHT,HID_KEY_ESCAPE, 0}},    // Escape key
