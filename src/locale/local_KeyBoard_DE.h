...
const UnicodeToKeyCode_t Keyboard_DE[] =
    {
        ...
        {'9', {HID_KEY_9, 0}},
        {'0', {HID_KEY_0, 0}},
        {0xdf, {HID_KEY_MINUS, 0}},
        {0xb4, {HID_KEY_EQUAL, 0}},
        ...
        {'k', {HID_KEY_K, 0}},
        {'l', {HID_KEY_L, 0}},
        {0xf6, {HID_KEY_SEMICOLON, 0}},
        {0xe4, {HID_KEY_APOSTROPHE, 0}},
        ...
        ///////////////////////////////////////////////// SHIFT
        // Top ROW ( numberts )
        {0xb0, {HID_KEY_SHIFT_LEFT, HID_KEY_GRAVE, 0}}, // '`'
        {'!', {HID_KEY_SHIFT_LEFT, HID_KEY_1, 0}},
        {'"', {HID_KEY_SHIFT_LEFT, HID_KEY_2, 0}},
        {0xa7, {HID_KEY_SHIFT_LEFT, HID_KEY_3, 0}},
        ...
        {0x60, {HID_KEY_SHIFT_LEFT, HID_KEY_EQUAL, 0}},
        // Second row qwerty[]\ in US
        ...
        {'Z', {HID_KEY_SHIFT_LEFT, HID_KEY_Y, 0}},
        ...
        {0xfc, {HID_KEY_SHIFT_LEFT, HID_KEY_BRACKET_LEFT, 0}},
        ...
        {0xd6, {HID_KEY_SHIFT_LEFT, HID_KEY_SEMICOLON, 0}},
        {0xc4, {HID_KEY_SHIFT_LEFT, HID_KEY_APOSTROPHE, 0}},
        // botom row zxcvbnm,./ in the US
        {'Y', {HID_KEY_SHIFT_LEFT, HID_KEY_Z, 0}},
        ...
        // thurted row asdfghjkl;' in US
        {'|', {HID_KEY_ALT_RIGHT, HID_KEY_A, 0}},
        {'\'', {HID_KEY_ALT_RIGHT, HID_KEY_APOSTROPHE, 0}},
        // botom row zxcvbnm,./ in the US
        {'|', {HID_KEY_ALT_RIGHT, HID_KEY_Z, 0}},
        {0xb5, {HID_KEY_ALT_RIGHT, HID_KEY_M, 0}},
